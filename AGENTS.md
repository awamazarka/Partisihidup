...
## Tujuan
Dokumen ini mendefinisikan *system prompt*, batasan, dan aturan perilaku untuk AI Coding Assistant (seperti VSCODE, gemini CLI, Cline, Roo, Antigravity, atau Cursor) yang bekerja pada proyek **onlydiecaster**. 
