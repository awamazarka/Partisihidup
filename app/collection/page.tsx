...
{`ALTER TABLE car_collection ADD COLUMN IF NOT EXISTS is_featured BOOLEAN DEFAULT false;`}
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="bg-white border-[4px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-2xl overflow-hidden flex flex-col">
                    <div className="h-80 skeleton-neon border-b-[4px] border-black" />
                    <div className="p-8 space-y-4">
                        <div className="h-8 w-3/4 skeleton-neon border-[1px] border-black" />
                        <div className="h-4 w-1/4 skeleton-neon border-[1px] border-black opacity-50" />
                        <div className="pt-6 flex justify-between">
                            <div className="h-6 w-20 skeleton-neon border-[1px] border-black" />
