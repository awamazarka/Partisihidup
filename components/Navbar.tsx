  ...
  return (
    <>
      ...
      >
        ...
        <div className={`
          lg:hidden absolute top-full left-1/2 -translate-x-1/2 w-[94%] mt-3 glass-effect border-[3px] border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] rounded-2xl overflow-hidden transition-all duration-500 transform origin-top pointer-events-auto
